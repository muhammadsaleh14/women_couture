...
exports.notificationRouter.use((0, authorize_1.authorizeRole)("ADMIN"));
exports.notificationRouter.get("/", notificationController.listNotifications);
exports.notificationRouter.patch("/:notificationId/read", notificationController.markRead);
